...
redisReply *clusterIncr(clusterContext *c, const char *key); // reply is integer value of key after incrementing it
redisReply *clusterDecr(clusterContext *c, const char *key); // reply is integer value of key after decrementing it
